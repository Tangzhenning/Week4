...
public class FakeDatabase {
    ...
    public static ArrayList<Article> getAllCollections() {
        return new ArrayList<Article>((List) Arrays.asList(collections.values().toArray()));
    }

    // You can ignore everything below this for now.
    private static final HashMap<Integer, Article> articles = new HashMap<>();
    private static final HashMap<Integer, Article> collections = new HashMap<>();

    public static void putCollection(int i, Article collection) {
        collections.put(i,collection);
    }
